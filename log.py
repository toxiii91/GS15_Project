...
def ecrire_log(nom_fonction, utilisateur, nom_fichier=None):
    ...
    messages = {
        ...
        "chiffrement_rsa": f"Utilisation RSA pour chiffrer le fichier \"{nom_fichier}\" de l'utilisateur {utilisateur} dans le coffre",
        "dechiffrement_rsa": f"Utilisation RSA pour dechiffrer le fichier \"{nom_fichier}\" de l'utilisateur {utilisateur} dans le coffre"
    }
